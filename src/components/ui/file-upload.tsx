                    ...
                    <div className="relative w-full mt-10 max-w-xl mx-auto">
                        ...
                        {!files.length && (
                            <motion.div
                                ...
                                className={cn(
                                    "relative group-hover/file:shadow-2xl z-40 bg-white bg-neutral-900 flex items-center justify-center h-32 mt-4 w-full max-w-[8rem] mx-auto rounded-md",
...
export function GridPattern() {
    ...
    const rows = 11;
    return (
        <div className="flex bg-gray-100 bg-neutral-900 flex-shrink-0 flex-wrap justify-center items-center gap-x-px gap-y-px  scale-105">
                    ...
                    return (
                        <div
                            ...
                            className={`w-10 h-10 flex flex-shrink-0 rounded-[2px] ${index % 2 === 0
                                ? "bg-gray-50 bg-neutral-950"
                                : "bg-gray-50 bg-neutral-950 shadow-[0px_0px_1px_3px_rgba(255,255,255,1)_inset] shadow-[0px_0px_1px_3px_rgba(0,0,0,1)_inset]"
                                }`}
                        />
                    );
                })
