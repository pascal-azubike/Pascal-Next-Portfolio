...
<body class="bg-zinc-900 text-white">
    ...
    <nav class="bg-zinc-900 max-w-5xl mx-auto py-4 px-6 flex items-center justify-between">
        ...
        <div class="hidden md:flex space-x-6">
            <a href="http://localhost:3000"><span class="text-white hover:text-gray-300 active:text-gray-400 transition-colors duration-200">About</span></a>
            <a href="http://localhost:3000"><span class="text-white hover:text-gray-300 active:text-gray-400 transition-colors duration-200">Projects</span></a>
            <a href="http://localhost:3000"><span class="text-white hover:text-gray-300 active:text-gray-400 transition-colors duration-200">Blogs</span></a>
        </div>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <footer class="border-t border-slate-900/5 py-10 max-w-6xl mx-auto px-8 mt-40">
            <div class="flex flex-col justify-center items-center py-10 relative">
                <a class="flex items-center mb-4 hover:opacity-80 active:opacity-70 transition-opacity duration-200" href="http://localhost:3000">
                ...
                <div class="flex flex-row justify-center space-x-2 mt-2">
                    <a href="http://localhost:3000" class="hover:text-gray-400 active:text-gray-500 text-zinc-500 text-sm relative transition-colors duration-200">
